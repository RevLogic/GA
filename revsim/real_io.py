...
class RealWriter:
    ...
    def write(self, file_name):
        ...
        # Construct list of garbage lines
        garbage_list = ["-"] * len(variable_list) # TODO: Add garbage output support to Cascades
                
        f.write("# GENERATED BY REVSIM BETA (http://github.com/RevLogic/GA)\n")
        f.write(".version " + REVLIB_VERSION_STRING + "\n")
        f.write(".numvars " + num_vars + "\n")
        f.write(".variables " + " ".join(variable_list) + "\n")
        f.write(".inputs " + " ".join(variable_list) + "\n")
        f.write(".outputs " + " ".join(variable_list) + "\n")
        f.write(".constants " + "".join(constant_list) + "\n") # NOTE: NO SPACES IN JOIN
        f.write(".garbage " + "".join(garbage_list) + "\n") # NOTE: ABOVE

        # Start writing out the Cascade
        f.write(".begin\n")
        for gate in self.c:
            f.write(str(gate) + "\n")
        f.write(".end\n")
